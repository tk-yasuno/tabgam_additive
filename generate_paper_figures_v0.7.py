"""
論文用の可視化スクリプト（v0.7 - Jet Engine RUL Prediction）
...
def load_results():
    """v0.7の結果を読み込み"""
    # モデル比較結果
    comparison_path = Path('outputs/results/all_models_comparison_v0.7_cmapss.csv')
    df_comparison = pd.read_csv(comparison_path)
    df_comparison = df_comparison.set_index('Model')
    
    # 最適化履歴
    tuning_path = Path('outputs/results/agentic_tuning_v0.7_cmapss.json')
...
def plot_model_comparison(df_comparison, save_path='outputs/figures/cmapss_v0.7/model_comparison_v0.7.png'):
    """
    Figure 1: モデル性能比較図
    """
    ...
    plt.suptitle('Jet Engine RUL Prediction (v0.7): Model Performance', 
...
def plot_optimization_process(tuning_results, save_path='outputs/figures/cmapss_v0.7/optimization_process_v0.7.png'):
    """
    ...
    plt.suptitle('Jet Engine RUL v0.7: Agentic Weight Optimization', 
...
def plot_optimal_weights(tuning_results, save_path='outputs/figures/cmapss_v0.7/optimal_weights_v0.7.png'):
    """
    Figure 3: 最適重みの円グラフ
    """
...
def plot_ensemble_comparison(df_comparison, save_path='outputs/figures/cmapss_v0.7/ensemble_comparison_v0.7.png'):
    """
...
def create_summary_table(df_comparison, tuning_results, save_path='outputs/figures/cmapss_v0.7/summary_table_v0.7.png'):
    """
    ...
    plt.title('Model Performance Summary\nJet Engine RUL Prediction v0.7', 
...
def main():
    """メイン実行"""
    print("=" * 80)
    print("Generating Figures for Paper (v0.7 - Jet Engine RUL Prediction)")
    print("=" * 80)
    ...
    print("=" * 80)
    print("\nOutput directory: outputs/figures/cmapss_v0.7/")
    print("\nFigures:")
    print("  1. model_comparison_v0.7.png - モデル性能比較")
    print("  2. optimization_process_v0.7.png - 最適化プロセス")
    print("  3. optimal_weights_v0.7.png - 最適重み")
    print("  4. ensemble_comparison_v0.7.png - アンサンブル比較")
    print("  5. summary_table_v0.7.png - サマリーテーブル")
    print("\n論文のFigureとして使用できます。")
